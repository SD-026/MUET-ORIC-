...
const Navbar = ({children}) => {
  ...
  const navItems = [
      ...
      subItems: [
        ...
        { name: "Team", path: "/about/team" },
        {
          ...
          subItems: [
            ...
            { name: "IP & Tech Transfer Policy", path: "/about/ip-tech-policy" }
          ]
        },
    ...
    },
    {
      name: "Collaboration",
      subItems: [
        { name: "Industrial Collaboration", path: "/collaboration/industrial-collobration" },
        { name: "Institutional Collaboration", path: "/collaboration/institutional-collobration" },
        { name: "Others Collaboration", path: "/collaboration/other-collaboration" }
      ]
    },
    {
      name: "Research & Innovations",
      subItems: [
        { name: "Funding Opportunity", path: "/research-innovation/funded-opportunity" },
        { name: "Funded Projects", path: "/research-innovation/funded-projects" },
        { name: "Research Journals", path: "/research-innovation/research-journals" }
      ]
    },
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/" className="flex items-center space-x-3 group">
                ...
                <div className="text-[17px] font-bold bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent leading-tight">
                  <motion.div >ORIC Mehran University</motion.div>
                  <div className="block text-[12px]">Of Engineering And Technology</div>
                  <div className="block text-[12px]">Jamshoro, Pakistan</div>
                </div>
              </Link>
