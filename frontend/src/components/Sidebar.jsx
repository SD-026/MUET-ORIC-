...
const SidebarWithNavbar = () => {
  ...
  const usermenuItems = [
    ...
    },
    {
      ...
      // link: '#',
      submenu: [
        { name: 'Request To Publish', link: 'All-Users' },
        { name: 'My Publish', link: 'All-Users' }
      ]
    },
      ...
      >
        <div className="flex flex-col h-full w-full">
          ...
          <div className="p-4 border-t border-[#112240]">
            {isOpen ? (
              <div className="flex items-center space-x-3">
                <div className="h-10 w-10 rounded-full bg-[#112240] flex items-center justify-center border border-[#233554]">
