...
const NewsAndEvents = () => {
  ...
  const newsItems = [
    {
      ...
      excerpt: "A Technical Session on Geothermal Energy was organized at the Science & Technology Park...",
      category: "Academic",
    ...
    },
    {
      ...
      excerpt: "ENGRO Corporation conducted a recruitment drive at Mehran University...",
      category: "Career",
      image: engroDrive,
    ...
    },
    {
      ...
      excerpt: "BitsPro is organizing a recruitment drive for fresh graduates in collaboration with ORIC...",
    ...
    },
    {
      ...
      excerpt: "The MUET Career Fair, organized by ORIC at Mehran University...",
      category: "Event",
      image: careerFair,
    ...
    },
    {
      ...
      excerpt: "Three talented teams from MUET recognized for innovative solutions...",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-16 px-4 sm:px-6 lg:px-8 mt-24">
          ...
          >
            {currentItems.map((item) => (
              ...
              >
                ...
                <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-bold ${categoryColors[item.category] || 'bg-gray-100 text-gray-800'}`}>
                  {item.category}
                </div>
