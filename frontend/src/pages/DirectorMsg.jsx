        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 xl:gap-24">
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-6 w-full translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
              <h3 className="text-2xl font-bold text-white">Dr. Tanveer Ahmed</h3>
              <p className="text-cyan-200 font-medium">Director, ORIC</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center mb-8">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">Dr. Tanveer Ahmed</h3>
                  <p className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600 font-medium">Director, ORIC</p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                >
                  Welcome to the Office of Research, Innovation, and Commercialization at Mehran University. We are committed to fostering an ecosystem where academic research transforms into impactful innovations that drive societal progress and economic growth.
                </motion.p>
