...
import { FaWhatsapp, FaPhoneAlt, FaExclamationCircle, FaFacebookF, FaInstagram, FaTwitter, FaYoutube, FaGithub, FaMapMarkerAlt,  FaEnvelope , FaPaperPlane } from 'react-icons/fa';
...
const ContactUsPage = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-[#0A192F] to-[#112240] min-h-screen py-12 px-4 sm:px-6 lg:px-8 mt-20">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-blue-400 mb-4">Get In Touch</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="backdrop-blur-md bg-white/10 rounded-2xl shadow-xl border border-white/20 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-white opacity-80 mb-1">
                  Your Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-white opacity-80 mb-1">
                  Email Address
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="subject" className="block text-sm font-medium text-white opacity-80 mb-1">
                  Subject
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-white opacity-80 mb-1">
                  Your Message
                </label>
                <textarea
                  id="message"
          ...
          <div className="space-y-6">
            ...
            <div className="backdrop-blur-md bg-white/10 rounded-2xl shadow-xl border border-white/20 overflow-hidden h-64">
              ...
              ></iframe> */}
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14415.533639019666!2d68.263074!3d25.408713!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x394c7960a341b7d9%3A0x5d6b29c80bc1f179!2sOffice%20of%20Research%2C%20Innovation%20%26%20Commercialization%2C%20Mehran%20University%20Jamshoro!5e0!3m2!1sen!2sus!4v1744432179951!5m2!1sen!2sus"  width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
                loading="lazy"
                title="Company Location"
                className="filter brightness(90%)" ></iframe>
            </div>
