...
import { Building, Link2, Download, ArrowLeft, ExternalLink } from "lucide-react";
import { useNavigate } from "react-router-dom";

 

// Import local images from assets folder
import pakistanCablesLogo from '../assets/companies/1.jpg';
import jpclLogo from '../assets/companies/1.jpg';
import dawlanceLogo from '../assets/companies/1.jpg';
import secmcLogo from '../assets/companies/1.jpg';
import engroLogo from '../assets/companies/1.jpg';
import hubcoLogo from '../assets/companies/1.jpg';
import haleonLogo from '../assets/companies/1.jpg';
import crescentLogo from '../assets/companies/1.jpg';
import aghaSteelLogo from '../assets/companies/1.jpg';
import sapphireLogo from '../assets/companies/1.jpg';
import libertyMillsLogo from '../assets/companies/1.jpg';
import ntdcLogo from '../assets/companies/1.jpg';
import fastCablesLogo from '../assets/companies/1.jpg';
import archromaLogo from '../assets/companies/1.jpg';

// Company data with local images
const companies = [
  { name: "Pakistan Cables", logo: pakistanCablesLogo, url: "https://www.pakistancables.com" },
  { name: "Jamshoro Power Company", logo: jpclLogo, url: "https://www.jpcl.com.pk" },
  { name: "Dawlance Pakistan", logo: dawlanceLogo, url: "https://www.dawlance.com.pk" },
  { name: "Sindh Engro Coal Mining", logo: secmcLogo, url: "https://www.secmc.com.pk" },
  ...
  { name: "Crescent Steel", logo: crescentLogo, url: "https://www.crescent.com.pk" },
  { name: "Agha Steel Mills", logo: aghaSteelLogo, url: "https://www.aghasteel.com" },
  { name: "Sapphire Textile Mills", logo: sapphireLogo, url: "https://www.sapphire.com.pk" },
  { name: "Liberty Mills", logo: libertyMillsLogo, url: "https://www.libertymills.com.pk" },
  { name: "NTDC", logo: ntdcLogo, url: "https://www.ntdc.com.pk" },
  { name: "Fast Cables", logo: fastCablesLogo, url: "https://www.fastcables.com" },
        ...
        >
          ...
          <div className="relative prose prose-invert max-w-none">
            <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6">
              With fierce competition, products don't stay popular for long, and companies need to keep up with new technology. 
              This means they're teaming up with universities like ORIC MUET and Mehran University of Engineering & Technology.
            </p>
            <p className="text-base leading-relaxed">
              This collaboration helps universities conduct better research while helping companies compete worldwide. 
              Companies gain access to brilliant researchers, the latest technology, and university facilities. 
              Universities obtain valuable data for research, funding opportunities, and real-world problem-solving 
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              ...
              <div className="text-xs sm:text-sm text-blue-300 max-w-md">
                Contains complete contact information, HR details, and application procedures for all partner companies
              </div>
            </div>
          </div>
        </motion.section>
